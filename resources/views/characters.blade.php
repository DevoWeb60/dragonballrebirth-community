        ...
        <div class="characters-container  flex-galery">
            @foreach ($characters as $character)
                @if (!$character->is_pnj)
                    <div class="character">
                        <div class="shadow">
                            <h2>{{ $character->name }} <img src="{{ $character->avatar }}transformations/base/head.png"
                                    alt="{{ $character->name }}"></h2>
                            <div class="presentation">
                                <div class="avatar">
                                    <img src="{{ $character->avatar }}avatars/1.png"
                        ...
                        <div class="story-unlock">
                            ...
                            @else
                                <p>
                                    <span class="step">{{ $character->ruby_cost }} <img
                                            src="https://www.dragonballrebirth.fr/css/images/ruby.svg" alt="rubis"></span>
                                </p>
                                <p>
                                    Boutique de Rubis
                                </p>
                        ...
                        <div class="caps">
                            <h3>Capsule <img src="{{ $capsIcon->icon }}" alt=""> </h3>
                            @if ($character->caps)
